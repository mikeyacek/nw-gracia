<?php /* Template Name: Šablona kosmetika-kurzy líčení */ ?>
...
if( !empty($image1) ): ?>
				...
				<!--<div class="objednavka_kad_leva">První ošetření s jednou aktivní látkou (colagen): <span class="telefon_c"><?php the_field('cena_liceni'); ?></span></div>-->
